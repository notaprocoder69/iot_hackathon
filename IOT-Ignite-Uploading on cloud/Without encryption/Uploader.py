...
Ultrasonic = data_pb2.Ultrasonic_Datapoint_2()
#aqi.pm10 = 18.9
...
while True:
    with open('sensor_data.csv', mode='r') as file:
        ...
        for row in csv_reader:
            # Extract data
            Ultrasonic.distance = int(float(row[1]))
            Ultrasonic.mac = row[2]
            ...
            # Publish the data
            device.publishData('Ultrasonic_Datapoint_2', Ultrasonic.SerializeToString())
